...
if __name__ == "__main__":
    INPUT = Path(r"D:\VKU\Nam_3\thuc_tap_doanh_nghiep_he_eSTI\EDUAGENT\src\modules\documents\doc_git\eval\eval_retriver\lich_su\dataset_lich_su_eval_retriver.md")  # sửa path thật
    run(INPUT)
