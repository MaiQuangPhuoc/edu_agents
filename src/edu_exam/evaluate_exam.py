...
PROMPT_PATH = Path(r'D:\VKU\Nam_3\thuc_tap_doanh_nghiep_he_eSTI\EDUAGENT\prompt_edu\prompt\verify_answer.txt')
...
def _verify_batch_by_llm(batch: list, retrieved_chunks: list, llm_client: LLMClient, template: str) -> list:
