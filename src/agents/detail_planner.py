...
class DetailPlannerPromptBuilder:
    def __init__(self):
        ...
        with open(
            r"D:\VKU\Nam_3\thuc_tap_doanh_nghiep_he_eSTI\EDUAGENT\prompts\detail_planner_sp.txt",
            "r", encoding="utf-8"
        ) as file:
        ...
        with open(
            r"D:\VKU\Nam_3\thuc_tap_doanh_nghiep_he_eSTI\EDUAGENT\prompts\detail_planner_um.txt",
            "r", encoding="utf-8"
        ) as file:
