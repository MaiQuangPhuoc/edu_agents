...
## Query 76
_LOI: Error code: 429 - {'error': {'message': 'Rate limit reached for model `openai/gpt-oss-120b` in organization `org_01kvktyvmzedwt157a5apq26ze` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Used 3989, Requested 4113. Please try again in 764.999999ms. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}_
...
## Query 85
_LOI: Error code: 429 - {'error': {'message': 'Rate limit reached for model `openai/gpt-oss-120b` in organization `org_01kvktyvmzedwt157a5apq26ze` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Used 3893, Requested 4211. Please try again in 779.999999ms. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}_
...
- LLM Accuracy (chỉ tính trên retrieval_hit): 95.56%
