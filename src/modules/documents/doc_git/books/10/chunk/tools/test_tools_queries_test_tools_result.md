...
Query 15: Tam giác ABC có b=8, c=5, góc A=60°. Tính cạnh a (dinh_ly_cosin)
...
Query 16: Tam giác ABC có a=10, b=7, c=6. Tính góc A (dinh_ly_cosin)
...
Query 17: Tam giác ABC có a=9, góc A=50°. Tính bán kính đường tròn ngoại tiếp (dinh_ly_sin)
...
Query 18: Giải tam giác ABC biết a=8, góc A=40°, góc B=70° (giai_tam_giac)
...
Query 19: Tính diện tích tam giác có 3 cạnh a=7, b=8, c=9 (dien_tich_tam_giac)
...
Query 25: Đo được số gần đúng của √5 là 2.236, số đúng là 2.2360679. Tính sai số tuyệt đối (sai_so_tuong_doi)
...
Tổng kết: 27/27 query có tool kỳ vọng nằm trong top-3
